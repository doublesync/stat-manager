...
I used [Django 5.0.2](https://www.djangoproject.com/) to my liking.  
Originally, I planned on implementing Typescript, but opted for a more simple option in [HTMX](https://htmx.org/).  
